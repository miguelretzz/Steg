           ...
           c = new ConvertToBMP();
     	   ...
     	   if(!secretFileName.equals("") && !msg.equals("")){
			    JOptionPane.showMessageDialog(parent,"You are trying to hide both Secret File and Secret Message"+
												" \nsteg is hiding Secret File only",
												"Warning",
           ...
           switch(result){
                ...
                case  4 : // success
                          if(coverType == BMP)
                               ...
                               outFileName = "test"+coverFileName.substring(coverFileName.indexOf('.'));

                          JOptionPane.showMessageDialog(parent, "Secret File successfully hidden" ,
